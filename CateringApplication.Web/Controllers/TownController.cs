...
namespace CateringApplication.Web.Controllers
{
    public class TownController : Controller
    {
        ...
        {
            TownListViewModel townListView = _townService.GetAll();

            // sorting when clicked on "Town"
        ...
        {
            TownViewModel townView = _townService.GetByID(id);
